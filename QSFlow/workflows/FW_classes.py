...
class Ligpargen_FW(Firework):
    def __init__(self, name=None, priority=None, smiles=None, con=None, Type=None, di=None, parents=None, mult=None,
                 **kwargs):
        spec = {'_category': 'processing', '_priority': priority, 'smiles': smiles, 'name': name, 'charge': con,
                "Type": Type} if priority else {'_category': 'gromacs', 'smiles': smiles, 'name': name, 'charge': con,
                                                "Type": Type, "dir": di,
                                                **kwargs}  # # this is passed in as fw_spec when you do fw_spec.get()
        # this is retrived
...
class Pack_FW(Firework):
    def __init__(self, name=None, parents=None, priority=None, solute_name=None, solvent_name=None, solvent_smiles=None,
                 solute_smiles=None, x=None, y=None, z=None, di=None, conmatrix=None, den=None, key=None,
                 titration_constant=1, intial=False, own_path=None, multi=None, charge=None, **kwargs):
        ...
        if solute_name is None:
            solute_name = []
        spec = {'_category': 'processing', '_priority': priority, "solute_name": solute_name,
                "solvent_name": solvent_name, "x": x, "y": y, "z": z, "dir": di, **kwargs} if priority else {
            '_category': 'gromacs', "dir": di, "solute_name": solute_name, "solvent_name": solvent_name, "x": x, "y": y,
            "z": z, "conmatrix": conmatrix, "den": den,
            **kwargs}  ## this is passed in as fw_spec when you do fw_spec.get() this is retrived
        t = [MDPrep(solute_name=solute_name, solvent_name=solvent_name, x=x, y=y, z=z, di=di, conmatrix=conmatrix,
                    den=den, key=key, solvent_smiles=solvent_smiles, solute_smiles=solute_smiles,
                    titration_constant=titration_constant, inital_sys=intial, own_path=own_path, multi=multi,
...
class Titrate(Firework):
    def __init__(self, name=None, parents=None, priority=None, solute_name=None, solvent_name=None, solvent_smiles=None,
                 solute_smiles=None, x=None, y=None, z=None, di=None, conmatrix=None, den=None, key=None,
                 titration_list=None, intial=False, own_path=None, **kwargs):
        if solute_smiles is None:
            solute_smiles = []
        if solvent_smiles is None:
            solvent_smiles = []
        ...
        t = [TitrationChargeScaler(solute_name=solute_name, solvent_name=solvent_name, x=x, y=y, z=z, di=di,
                                   conmatrix=conmatrix, den=den, key=key, solvent_smiles=solvent_smiles,
                                   solute_smiles=solute_smiles, titration_list=titration_list, inital_sys=intial,
                                   own_path=own_path)]  ## this is passed for self, self.get() gets this
        super(Titrate, self).__init__(t, parents=parents, spec=spec, name=name)


class EM_FW(Firework):
    def __init__(self, name=None, parents=None, priority=None, solute_name=None, solvent_name=None, x=None, y=None,
                 z=None, di=None, conmatrix=None, den=None, key=None, **kwargs):
        if solvent_name is None:
            solvent_name = []
        if solute_name is None:
            solute_name = []
...
class Density_FW(Firework):
    def __init__(self, name=None, parents=None, priority=None, name_tag='', solute_name=None, solvent_name=None, x=None,
                 y=None, z=None, di=None, conmatrix=None, den=None, key=None, **kwargs):
        if solvent_name is None:
            solvent_name = []
        if solute_name is None:
            solute_name = []
...
class Check_FW(Firework):
    def __init__(self, name=None, parents=None, priority=None, name_tag='', solute_name=None, solvent_name=None, x=None,
                 y=None, z=None, di=None, conmatrix=None, den=None, key=None, mm=None, path_to_folder=None, **kwargs):
        if solute_name is None:
            solute_name = []
        if solvent_name is None:
            solvent_name = []
        spec = {'_category': 'processing', '_priority': priority, "solute_name": solute_name,
                "solvent_name": solvent_name, "x": x, "y": y, "z": z, "dir": di, **kwargs} if priority else {
            '_category': 'gromacs', "dir": di, "solute_name": solute_name, "solvent_name": solvent_name, "x": x, "y": y,
            "z": z, "conmatrix": conmatrix, "den": den, "MM": mm, "path_to_folder": path_to_folder,
            **kwargs}  ## this is passed in as fw_spec when you do fw_spec.get() this is retrived
